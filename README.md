...
<https://eagleoutice.github.io/satex/> with details on the assumed [concrete TeX/eTeX semantics][concrete semantics], the [linting rules](https://eagleoutice.github.io/satex/wiki/lints), all supported [queries](https://eagleoutice.github.io/satex/wiki/queries) and the
...
[concrete semantics]: https://eagleoutice.github.io/satex/SEMANTICS
[config]: https://eagleoutice.github.io/satex/wiki/configuration